...
public class Formato14CGartController {
	...
	public void editar(ModelMap model,ResourceRequest request,ResourceResponse response,
		...
		try {	
		    ...
		    pRequest.getPortletSession().setAttribute("peridoEnvioEdit", f.getPeriodoEnvio(), PortletSession.APPLICATION_SCOPE);
		    pRequest.getPortletSession().setAttribute("flagCostoEdit", f.getFlagCosto(), PortletSession.APPLICATION_SCOPE);
	...
	public void grabarF14C(ModelMap model, ResourceRequest request,ResourceResponse response,
		...
		try {				
			...
			String valor ="0";
				try {
					valor = formato14CGartService.insertarDatosFormato14C(f);
				} catch (Exception e) {
					valor="0";
				}			
			if(valor.equals("1")){ 
	...
	public void actualizarF14C(ModelMap model, ResourceRequest request,ResourceResponse response,
		...
		try {				
			...
			String valor ="0";
				try {
					valor = formato14CGartService.actualizarDatosFormato14C(f);
				} catch (Exception e) {
					valor="0";
				}			
			if(valor.equals("1")){ 
	...
	public void eliminarF14C(ModelMap model, ResourceRequest request,ResourceResponse response,
		...
		try {				
			...
			String valor ="0";
				try {
					valor = formato14CGartService.eliminarDatosFormato14C(f);
				} catch (Exception e) {
					valor="0";
				}			
			if(valor.equals("1")){ 
	...
	public void cargarDocumento(ActionRequest request,ActionResponse response,
		...
		//String peridoEnvioEdit = (String)pRequest.getPortletSession().getAttribute("peridoEnvioEdit", PortletSession.APPLICATION_SCOPE);
		String flagCostoEdit = (String)pRequest.getPortletSession().getAttribute("flagCostoEdit", PortletSession.APPLICATION_SCOPE);
		...
		if(formatoMensaje.getListaMensajeError()!=null && formatoMensaje.getListaMensajeError().size()>0){
			...
			if(flagCarga.equals(FiseConstants.FLAG_CARGAEXCEL_FORMULARIONUEVO) || 
					flagCarga.equals(FiseConstants.FLAG_CARGATXT_FORMULARIONUEVO) ){
				pRequest.getPortletSession().setAttribute("mensajeInformacion", "El Formato 14C se guardó satisfactoriamente", PortletSession.APPLICATION_SCOPE);	
			}else if( flagCarga.equals(FiseConstants.FLAG_CARGAEXCEL_FORMULARIOMODIFICACION) || 
					flagCarga.equals(FiseConstants.FLAG_CARGATXT_FORMULARIOMODIFICACION) ){
				pRequest.getPortletSession().setAttribute("mensajeInformacion", "El Formato 14C se actualizó satisfactoriamente", PortletSession.APPLICATION_SCOPE);
			}			
		}
	    ...
	    pRequest.getPortletSession().setAttribute("flagCostoEdit", "", PortletSession.APPLICATION_SCOPE);
			...
			if (archivo != null) {
				...
				if (libro != null) {
					...
					if(process){
						...
						}else if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getAnioPres())){						
							cont++;
							sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
						...
						}else if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getMesPres())){ 						
							cont++;
							sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
						...
						if(FormatoUtil.isNotBlank(bean.getNumRural()) &&
								!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getNumRural())){ 						
							cont++;
							sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
						...
						if(FormatoUtil.isNotBlank(bean.getNumUrbProv()) &&
								!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getNumUrbProv())){ 						
							cont++;
							sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								FiseConstants.COD_EMPRESA_LUZ_SUR.equals(codEmpresa))
						{
						    ...
						    if(FormatoUtil.isNotBlank(bean.getNumUrbLima())&&
						    		!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getNumUrbLima())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							if(FormatoUtil.isNotBlank(bean.getCostoPromUrbLima())&&
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostoPromUrbLima())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
						...
						if(FormatoUtil.isNotBlank(bean.getCostoPromRural()) &&
								!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostoPromRural())){ 						
							cont++;
							sMsg="ERROR";
							fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
						...
						if(FormatoUtil.isNotBlank(bean.getCostoPromUrbProv()) &&
								!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostoPromUrbProv())){ 						
							cont++;
							sMsg="ERROR";
							fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
						...
						{ 
							...
							if(FormatoUtil.isNotBlank(bean.getCanDRCoord()) &&
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDRCoord()) || 
									Integer.valueOf(bean.getCanDRCoord().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 								
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							if(FormatoUtil.isNotBlank(bean.getCostDRCoord()) &&
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDRCoord())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanDRSupe())){							
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDRSupe()) || 
									Integer.valueOf(bean.getCanDRSupe().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostDRSupe())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDRSupe())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanDRGest())){							
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDRGest()) || 
									Integer.valueOf(bean.getCanDRGest().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostDRGest())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDRGest())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanDRAsist())){						
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDRAsist()) || 
									Integer.valueOf(bean.getCanDRAsist().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostDRAsist())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDRAsist())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanDPCoord())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDPCoord()) || 
									Integer.valueOf(bean.getCanDPCoord().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostDPCoord())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDPCoord())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanDPSupe())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDPSupe()) || 
									Integer.valueOf(bean.getCanDPSupe().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostDPSupe())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDPSupe())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanDPGest())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDPGest()) || 
									Integer.valueOf(bean.getCanDPGest().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostDPGest())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDPGest())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanDPAsist())){							
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDPAsist()) || 
									Integer.valueOf(bean.getCanDPAsist().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostDPAsist())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDPAsist())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									FiseConstants.COD_EMPRESA_LUZ_SUR.equals(codEmpresa))
							{
								...
								/*if(FormatoUtil.isNotBlank(bean.getCanDLCoord())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDLCoord()) || 
										Integer.valueOf(bean.getCanDLCoord().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCostDLCoord())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDLCoord())){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCanDLSupe())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDLSupe()) ||
										Integer.valueOf(bean.getCanDLSupe().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCostDLSupe())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDLSupe())){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCanDLGest())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDLGest()) ||
										Integer.valueOf(bean.getCanDLGest().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCostDLGest())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDLGest())){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCanDLAsist())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDLAsist()) ||
										Integer.valueOf(bean.getCanDLAsist().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCostDLAsist())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDLAsist())){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanIRCoord())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIRCoord()) || 
									Integer.valueOf(bean.getCanIRCoord().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostIRCoord())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIRCoord())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanIRSupe())){							
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIRSupe()) || 
									Integer.valueOf(bean.getCanIRSupe().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostIRSupe())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIRSupe())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanIRGest())){							
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIRGest()) || 
									Integer.valueOf(bean.getCanIRGest().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostIRGest())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIRGest())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanIRAsist())){						
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIRAsist()) || 
									Integer.valueOf(bean.getCanIRAsist().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostIRAsist())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIRAsist())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanIPCoord())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIPCoord()) || 
									Integer.valueOf(bean.getCanIPCoord().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostIPCoord())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIPCoord())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanIPSupe())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIPSupe()) || 
									Integer.valueOf(bean.getCanIPSupe().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostIPSupe())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIPSupe())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanIPGest())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIPGest()) || 
									Integer.valueOf(bean.getCanIPGest().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostIPGest())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIPGest())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCanIPAsist())){							
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIPAsist()) || 
									Integer.valueOf(bean.getCanIPAsist().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
							...
							/*if(FormatoUtil.isNotBlank(bean.getCostIPAsist())){					
								...
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIPAsist())){ 						
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
									...
									FiseConstants.COD_EMPRESA_LUZ_SUR.equals(codEmpresa))
							{
								...
								/*if(FormatoUtil.isNotBlank(bean.getCanILCoord())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanILCoord()) ||
										Integer.valueOf(bean.getCanILCoord().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCostILCoord())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostILCoord())){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCanILSupe())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanILSupe()) ||
										Integer.valueOf(bean.getCanILSupe().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCostILSupe())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostILSupe())){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCanILGest())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanILGest()) ||
										Integer.valueOf(bean.getCanILGest().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCostILGest())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostILGest())){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCanILAsist())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanILAsist()) ||
										Integer.valueOf(bean.getCanILAsist().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
								...
								/*if(FormatoUtil.isNotBlank(bean.getCostILAsist())){					
									...
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										...
										!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostILAsist())){ 						
									cont++;
									sMsg="ERROR";
									fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
						...
						}else
						{
							...
							if(FormatoUtil.isNotBlank(bean.getCanDRCoord()) &&
									Integer.valueOf(bean.getCanDRCoord().length().length())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){							
								cont++;
								sMsg="ERROR";
								fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
										listaError, cont, FiseConstants.COD_ERROR_F14C_510);
    ...
    private Formato14AMensajeBean readTxtFile(FileEntry archivo, 
    	...
    	try{
    		...
    		if( listaCampo != null ){
    			...
    			String nombreIdeal = FormatoUtil.nombreArchivoCargaTxt(Long.parseLong(anioPresentacion), Long.parseLong(mesPresentacion), codigoEmpresa, FiseConstants.TIPO_FORMATO_14C);
				if( nombreIdeal.trim().equals(archivo.getDescription().trim()) ){
	    		   ...
	    		   /*****validaciones de consistencia***/
	    			if(process && FiseConstants.BLANCO.equals(sMsg)){
	    				/**CABECERA**/
	    				if(!FormatoUtil.validarCampoLongEnteroPositivoTxt(bean.getAnioPres())){    				
	    					cont++;
	    					sMsg="ERROR";    
	    					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	    							listaError, cont, FiseConstants.COD_ERROR_F12_60);
	    				}
	    				if(!FormatoUtil.validarCampoLongEnteroPositivoTxt(bean.getMesPres())){    				
	    					cont++;
	    					sMsg="ERROR";    
	    					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	    							listaError, cont, FiseConstants.COD_ERROR_F12_80);
	    				}
	    				if(!FormatoUtil.validarCampoLongEnteroPositivoTxt(bean.getNumRural())){    				
	    					cont++;
	    					sMsg="ERROR";    
	    					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	    							listaError, cont, FiseConstants.COD_ERROR_F14C_390);
	    				}
	    				if(!FormatoUtil.validarCampoLongEnteroPositivoTxt(bean.getNumUrbProv())){    				
	    					cont++;
	    					sMsg="ERROR";    
	    					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	    							listaError, cont, FiseConstants.COD_ERROR_F14C_410);
	    				...
	    				if(FiseConstants.COD_EMPRESA_EDELNOR.equals(codigoEmpresa) || 
								FiseConstants.COD_EMPRESA_LUZ_SUR.equals(codigoEmpresa))
						{
	    					if(!FormatoUtil.validarCampoLongEnteroPositivoTxt(bean.getNumUrbLima())){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_430);
	        				}
	    					if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostoPromUrbLima()) ){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_490);
	    				...
	    				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostoPromRural()) ){    				
	    					cont++;
	    					sMsg="ERROR";    
	    					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	    							listaError, cont, FiseConstants.COD_ERROR_F14C_450);
	    				}
	    				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostoPromUrbProv()) ){    				
	    					cont++;
	    					sMsg="ERROR";    
	    					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	    							listaError, cont, FiseConstants.COD_ERROR_F14C_470);
	    				...
	    				if(FiseConstants.COSTO_DIRECTO_F14C.equals(flagCosto)){
	    					/*****RURAL*****/     
	    					if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDRCoord()) ||
	    							Integer.valueOf(bean.getCanDRCoord())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_510);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDRSupe()) ||
	        						Integer.valueOf(bean.getCanDRSupe())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){   				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_590);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDRGest()) ||
	        						Integer.valueOf(bean.getCanDRGest())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_670);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDRAsist()) ||
	        						Integer.valueOf(bean.getCanDRAsist())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_750);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDRCoord()) ){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					 fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_530);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDRSupe()) ){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_610);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDRGest()) ){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_690);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDRAsist()) ){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_770);
	        				...
	        				/*****PROVINCIA*****/    
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDPCoord()) ||
	        						Integer.valueOf(bean.getCanDPCoord())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_830);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDPSupe()) ||
	        						Integer.valueOf(bean.getCanDPSupe())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_910);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDPGest()) ||
	        						Integer.valueOf(bean.getCanDPGest())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_990);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDPAsist()) ||
	        						Integer.valueOf(bean.getCanDPAsist())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_1070);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDPCoord()) ){    			
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_850);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDPSupe()) ){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_930);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDPGest()) ){    			
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_1010);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDPAsist()) ){    			
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_1090);
	        				...
	        				if(FiseConstants.COD_EMPRESA_EDELNOR.equals(codigoEmpresa) || 
	    							FiseConstants.COD_EMPRESA_LUZ_SUR.equals(codigoEmpresa))
	    					{
	        					if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDLCoord()) ||
	        							Integer.valueOf(bean.getCanDLCoord())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    		
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1150);
	            				}
	            				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDLSupe()) ||
	            						Integer.valueOf(bean.getCanDLSupe())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    				
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1230);
	            				}
	            				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDLGest()) ||
	            						Integer.valueOf(bean.getCanDLGest())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    			
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1310);
	            				}
	            				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDLAsist()) ||
	            						Integer.valueOf(bean.getCanDLAsist())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    			
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1390);
	            				}
	            				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDLCoord()) ){    					
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1170);
	            				}
	            				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDLSupe()) ){    				
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1250);
	            				}
	            				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDLGest()) ){    				
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1330);
	            				}
	            				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostDLAsist()) ){    				
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores,
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1410);
	    					...
	    					/*****RURAL*****/     
	    					if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIRCoord()) ||
	    							Integer.valueOf(bean.getCanIRCoord())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_550);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIRSupe()) ||
	        						Integer.valueOf(bean.getCanIRSupe())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_630);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIRGest()) ||
	        						Integer.valueOf(bean.getCanIRGest())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_710);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIRAsist()) ||
	        						Integer.valueOf(bean.getCanIRAsist())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_790);
	        				}  
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIRCoord()) ){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_570);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIRSupe()) ){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_650);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIRGest()) ){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_730);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIRAsist()) ){    					
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_810);
	    					...
	    					/*****PROVINCIA*****/ 
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIPCoord()) ||
	        						Integer.valueOf(bean.getCanIPCoord())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_870);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIPSupe()) ||
	        						Integer.valueOf(bean.getCanIPSupe())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_950);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIPGest()) ||
	        						Integer.valueOf(bean.getCanIPGest())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    			
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_1030);
	        				}
	        				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanIPAsist()) ||
	        						Integer.valueOf(bean.getCanIPAsist())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    			
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_1530);
	        				}    	
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIPCoord()) ){    				
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_890);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIPSupe()) ){    		
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_970);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIPGest()) ){    			
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_1050);
	        				}
	        				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostIPAsist()) ){    			
	        					cont++;
	        					sMsg="ERROR";    
	        					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	        							listaError, cont, FiseConstants.COD_ERROR_F14C_1130);
	        				...
	        				if(FiseConstants.COD_EMPRESA_EDELNOR.equals(codigoEmpresa) || 
	    							FiseConstants.COD_EMPRESA_LUZ_SUR.equals(codigoEmpresa))
	    					{
	        					if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanILCoord()) ||
	        							Integer.valueOf(bean.getCanILCoord())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    				
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1190);
	            				}
	            				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanILSupe()) ||
	            						Integer.valueOf(bean.getCanILSupe())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    			
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1270);
	            				}
	            				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanILGest()) ||
	            						Integer.valueOf(bean.getCanILGest())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    			
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1350);
	            				}
	            				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanILAsist()) ||
	            						Integer.valueOf(bean.getCanILAsist())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    				
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1430);
	            				}	
	            				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostILCoord()) ){    				
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1210);
	            				}
	            				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostILSupe()) ){    			
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1290);
	            				}
	            				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostILGest()) ){    				
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1370);
	            				}
	            				if( !FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCostILAsist()) ){    				
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1450);
	    							...
	    							FiseConstants.COD_EMPRESA_LUZ_SUR.equals(codigoEmpresa))
	    					{
	        					/**LIMA***/
	            				if(!FormatoUtil.validarCampoBigDecimalPositivoTxt(bean.getCanDLCoord()) ||
	            						Long.valueOf(bean.getCanDLCoord())>FiseConstants.TAMANIO_COLUMNA_CANTIDAD_COSTO_D_I_F14C){    		
	            					cont++;
	            					sMsg="ERROR";    
	            					fiseUtil.agregarErrorBeanConMensaje(sMsg, mapaErrores, 
	            							listaError, cont, FiseConstants.COD_ERROR_F14C_1150);
