<%@include file="/WEB-INF/jsps/gart/ext/extTipoGasto.jsp"%>
							...
							<td class="filete">
								<fieldset class="">
									<table class="" style="width: 100%;" border="0">
										...
										<tr>
											<td><output>Id Tipo Gasto:</output></td>
											<td>
										...
										<tr>
											...
											<td></td>
											<td></td>											
											<td><input name="<portlet:namespace/>btnBuscarTipogasto"
												id="<portlet:namespace/>btnBuscarTipogasto" type="button"
										...
										<td align="right" width="90px">
											<div id="d_opc_crear">
												<input type="button" class="net-button-small"
													id="<portlet:namespace/>btnNuevoTipoGasto"
													name="<portlet:namespace/>btnNuevoTipoGasto" value="Nuevo" />
											</div>
										</td>
										<td align="right" width="90px">											
										</td>
								...
								<fieldset class="">
									...
									<table class="" border="0" width="100%">
									   <tr class="filete-bottom">
											<td><output class="net-titulo">TIPO DE GASTO</output>
											</td>
										</tr>
										<tr height="10px">
											<td></td>
										...
										<tr>
									     <td>											
										   <table style="width: 100%;" border="0">
											  <tr>											  
											    <td style="width: 150px;"><label style="font-size: 12px; font-weight: bold">Id Tipo Gasto:</label>
												</td>
											    <td>
												  ...
												  <table style="width: 100%">
												    <tr>													  
													 <td width="17%" align="center">													  
														  <input type="button" class="net-button-small" id="<portlet:namespace/>btnActualizarTipoGasto"
															   name="<portlet:namespace/>btnActualizarTipoGasto" value="Actualizar" style="display: none;"/>
																												
														<input type="button" class="net-button-small" id="<portlet:namespace/>btnGuardarTipoGasto"
															   name="<portlet:namespace/>btnGuardarTipoGasto" value="Grabar" />									   
													 </td>													
													 <td width="17%" align="center">
														<input type="button" class="net-button-small" id="<portlet:namespace/>btnRegresarTipoGasto" 
															  name="<portlet:namespace/>btnRegresarTipoGasto" value="Regresar" />
													 </td>
												 </tr>
											  </table>
											</td>
