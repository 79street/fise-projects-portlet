...
$(document).ready(function () {	
	formato12D.initCRUD('${crud}', '${urlAnadirFormato}','${urlRegresarBusqueda}');
});
</script>


<form:form  method="POST" modelAttribute="formato12DCBean" action="${accionURL}" enctype="multipart/form-data">
								...
								<fieldset class="">
									...
									<table class="" border="0" width="100%">
										<tr class="filete-bottom">
											<td><output class="net-titulo">FORMATO FISE-12D: </output> Detalle de Gastos por Actividades Extraordinarias</td>
										</tr>
										<tr height="10px">
											<td></td>
										</tr>
										...
										<tr>
											<td>
												<table class="" style="width: 100%;" border="0">
													<tr>
														<td width="163px">Distribuidora Eléctrica:</td>
														<td>
															<form:select path="codigoEmpresa" cssClass="select" cssStyle="width: 375px;" disabled="${formato12DCBean.readOnly}" >
														...
														<td width="45%">
															<fieldset class="net-frame-border">
																<table>
																	...
																	<tr>
																		<td colspan="5">
																		   <form:select path="periodoEnvio" cssClass="select" cssStyle="width: 300px;" disabled="${formato12DCBean.readOnly}" >
																				<c:forEach items="${formato12DCBean.listaPeriodo}" var="item">
																					<form:option value="${item.codigoItem}">${item.descripcionItem}</form:option>
																				</c:forEach>
																			</form:select> 
																		</td>
																		 <td colspan="5" style="padding-left: 15px;">
																		 	<%-- <form:input path="descGrupoInformacion" style="display: none;border-radius: 7px;"  disabled="${formato12DCBean.readOnly}" /> --%>
																		 </td>
																		 <td colspan="5" style="padding-left: 15px;">
																		 	<%-- <form:input path="descEstado" style="display: none;border-radius: 7px;"  disabled="${formato12DCBean.readOnly}" /> --%>
																		 </td>
																	</tr>
																</table>
															</fieldset>
																...
																<fieldset class="net-frame-border" style="padding-left: 15px;">
																	<table>
																		...
																		<tr>
																			...
																			<td colspan="5">
																				<form:input path="anioEjecucionDetalle" style="width: 50px;" disabled="${formato12DCBean.readOnly}" />
																			</td>
																			<td colspan="5">
																				<form:input path="mesEjecucionDetalle" style="width: 100px;" disabled="${formato12DCBean.readOnly}" />	
																			</td>
																		</tr>
																	</table>
																</fieldset>
					...
					<div id="<portlet:namespace/>dialog-form-cargaExcel"
						...
						<div
							...
							<span class="ui-dialog-title"
								...
								onclick="formato12D.closeDialogCargaExcel();"> <span
						...
						<div class="ui-dialog-content ui-widget-content">
							...
							<fieldset class="">
								<table style="width: 100%;">
									...
									<tr>
										<td>Archivo:</td>
										<td><input type="file" id="archivoExcel" onclick="formato12D.iniciarMensajeExcel();"
						...
						<div
							...
							<div class="ui-dialog-buttonset">
								...
								<input type="button" class="net-button-small"
									...
									onclick="formato12D.closeDialogCargaExcel();" />
							</div>
						</div>
					</div>
					...
					<div id="<portlet:namespace/>dialog-form-cargaTxt"
						...
						<div
							...
							<span class="ui-dialog-title"
								...
								role="button" onclick="formato12D.closeDialogCargaTxt();"> <span
								class="ui-icon ui-icon-closethick">close</span>
							</a>
						</div>
						...
						<div class="ui-dialog-content ui-widget-content">
							...
							<fieldset class="">
								<table style="width: 100%;">
									...
									<tr>
										<td>Archivo:</td>
										<td><input type="file" id="archivoTxt" name="archivoTxt" onclick="formato12D.iniciarMensajeTxt();" /></td>
									</tr>
									<tr>
						...
						<div
							...
							<div class="ui-dialog-buttonset">
								<input type="button" class="net-button-small"
									...
									onclick="formato12D.closeDialogCargaTxt();" />
							</div>
						</div>
					</div>
				</c:if>
