...
var formato12D= {
	...
	initCRUD : function(operacion,urlAnadirFormato,urlRegresarBusqueda){
		...
		formato12D.btnExcel.click(function() {
			if( formato12D.validarGrupoInformacion() ){
				if( formato12D.validarUltimaEtapa() ){
	...
	validarUltimaEtapa : function(){
		if( $('#etapaFinal').val()=='SI' ){
			formato12D.dialogMessageWarningCrudContent.html('No se puede realizar esta operación debido a que el Formato se encuentra en una etapa avanzada');
			formato12D.dialogMessageWarningCrud.dialog("open");
			return false;
		}
		return true;
	...
	validarFormatoDetalle : function(){
		...
		if( parseFloat(formato12D.anoEjecucionDetalle.val())*100 + parseFloat(formato12D.mesEjecucionDetalle.val()) > parseFloat(formato12D.anoPresentacionDetalle.val())*100 + parseFloat(formato12D.mesPresentacionDetalle.val()) ){
			formato12D.dialogMessageWarningDetalleContent.html("El Periodo de Ejecución no puede ser mayor al Periodo a Declarar");
			formato12D.dialogMessageWarningDetalle.dialog("open");
			return false;
		}
	...
	soloNumerosEnteros : function(){
		formato12D.cantidadDetalle.attr("onkeypress","return soloNumerosEntero(event, 1, 'cantidad',6,0)");
	},
