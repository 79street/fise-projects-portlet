...
var formato14A= {
	...
	soloNumerosDecimales : function(){
		//RURAL
		formato14A.f_impEsqInvR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprEsqInvitR',7,2)");
		formato14A.f_impDeclJuradaR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprDeclaJuradaR',7,2)");
		formato14A.f_impFichaVerifR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprFichaVerifR',7,2)");
		formato14A.f_repEsqInvR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'repartoEsqInvitR',7,2)");
		formato14A.f_verifInfoR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'verifInfoR',7,2)");
		formato14A.f_elabArchBenefR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'elabArchivoBenefR',7,2)");
		formato14A.f_digitFichaR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'digitFichaBenefR',7,2)");
		formato14A.f_impVolanteR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprVolantesR',7,2)");
		formato14A.f_impAficheR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprAfichesR',7,2)");
		formato14A.f_repFolletoR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'repFolletosR',7,2)");
		formato14A.f_spotPublicTvR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'spotPublTvR',7,2)");
		formato14A.f_spotPublicRadioR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'spotPublRadioR',7,2)");
		formato14A.f_promConvR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'promConvAgentR',7,2)");
		formato14A.f_regFirmaConvR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'regConvAgentR',7,2)");
		formato14A.f_impBandR.attr("onkeypress","return soloNumerosDecimales(event, 2, 'impEntrBandR',7,2)");
		//PROVINCIA
		formato14A.f_impEsqInvP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprEsqInvitP',7,2)");
		formato14A.f_impDeclJuradaP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprDeclaJuradaP',7,2)");
		formato14A.f_impFichaVerifP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprFichaVerifP',7,2)");
		formato14A.f_repEsqInvP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'repartoEsqInvitP',7,2)");
		formato14A.f_verifInfoP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'verifInfoP',7,2)");
		formato14A.f_elabArchBenefP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'elabArchivoBenefP',7,2)");
		formato14A.f_digitFichaP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'digitFichaBenefP',7,2)");
		formato14A.f_impVolanteP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprVolantesP',7,2)");
		formato14A.f_impAficheP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprAfichesP',7,2)");
		formato14A.f_repFolletoP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'repFolletosP',7,2)");
		formato14A.f_spotPublicTvP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'spotPublTvP',7,2)");
		formato14A.f_spotPublicRadioP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'spotPublRadioP',7,2)");
		formato14A.f_promConvP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'promConvAgentP',7,2)");
		formato14A.f_regFirmaConvP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'regConvAgentP',7,2)");
		formato14A.f_impBandP.attr("onkeypress","return soloNumerosDecimales(event, 2, 'impEntrBandP',7,2)");
		//LIMA
		formato14A.f_impEsqInvL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprEsqInvitL',7,2)");
		formato14A.f_impDeclJuradaL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprDeclaJuradaL',7,2)");
		formato14A.f_impFichaVerifL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprFichaVerifL',7,2)");
		formato14A.f_repEsqInvL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'repartoEsqInvitL',7,2)");
		formato14A.f_verifInfoL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'verifInfoL',7,2)");
		formato14A.f_elabArchBenefL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'elabArchivoBenefL',7,2)");
		formato14A.f_digitFichaL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'digitFichaBenefL',7,2)");
		formato14A.f_impVolanteL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprVolantesL',7,2)");
		formato14A.f_impAficheL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'imprAfichesL',7,2)");
		formato14A.f_repFolletoL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'repFolletosL',7,2)");
		formato14A.f_spotPublicTvL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'spotPublTvL',7,2)");
		formato14A.f_spotPublicRadioL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'spotPublRadioL',7,2)");
		formato14A.f_promConvL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'promConvAgentL',7,2)");
		formato14A.f_regFirmaConvL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'regConvAgentL',7,2)");
		formato14A.f_impBandL.attr("onkeypress","return soloNumerosDecimales(event, 2, 'impEntrBandL',7,2)");
	},
	...
	validarGrupoInformacion : function(){
		if( $('#idGrupoInfo').val()=='0' ){
			...
			formato14A.dialogMessageWarningContent.html('Primero debe estar creado el Grupo de Información Bienal para el Año y Mes a declarar');
			formato14A.dialogMessageWarning.dialog("open");
			return false;
		}
		return true;
