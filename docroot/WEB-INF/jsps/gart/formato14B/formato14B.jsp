									...
									<table class="" border="0" width="100%">
										<tr class="filete-bottom">
											<td><output class="net-titulo">FORMATO FISE-14B:
												</output>COSTOS ESTÁNDARES OPERATIVOS - MENSUAL</td>
										</tr>
										<tr height="10px">
											<td></td>
										</tr>
					...
					<div class="ui-dialog-content ui-widget-content">
						...
						<fieldset class="">
							<table style="width: 100%;">
								...
								<tr>
									<td>Archivo:</td>
									<td><input type="file" id="archivoExcel" name="archivoExcel" onclick="formato12C.iniciarMensajeExcel();" /></td>
								</tr>
								<tr>
					...
					<div class="ui-dialog-content ui-widget-content">
						...
						<fieldset class="">
							<table style="width: 100%;">
								...
								<tr>
									<td>Archivo:</td>
									<td><input type="file" id="archivoTxt" name="archivoTxt" onclick="formato12C.iniciarMensajeTxt();" />
									</td>
								</tr>
								<tr>
									<td colspan="2" height="10px;"></td>
