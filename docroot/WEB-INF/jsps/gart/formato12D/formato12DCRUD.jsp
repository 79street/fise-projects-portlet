																...
																<fieldset class="net-frame-border" style="padding-left: 15px;">
																	<table>
																		...
																		<tr>
																			...
																			<td colspan="5">
																				<form:input path="anioInicioVigencia" style="width: 50px;" disabled="${formato12DCBean.readOnly}" />
																			</td>
																			<td colspan="5">
																				<form:input path="anioFinVigencia" style="width: 50px;" disabled="${formato12DCBean.readOnly}" />	
																			</td>
																		</tr>
																	</table>
																</fieldset>
